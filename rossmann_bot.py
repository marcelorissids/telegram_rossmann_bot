...
# Webhook
# https://api.telegram.org/bot6142592087:AAHBo5lRz-PK6oDOLTR13BSesFK8KBfnjfQ/setWebhook?url=https://telegram-rossmann-bot-xcy0.onrender.com
...
def predict(data):
    ...
    # API Call
    url = 'https://webapp-rossmann-w7wl.onrender.com/rossmann/predict'
